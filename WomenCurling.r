...
#Specifying the url for desired website to be scrapped and women versus men

# Women's Curling Olympics 2018
participants <- "Women"
...
# Exponents from 1.9 to 4.1 (by 0.1) were used in the computations, and 3.4 had the lowest mean-squared-error of that set
